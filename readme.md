...
- FARLR_EMM: Factor-augmented regularized latent regression estimated
  via an iterative EMM-style procedure.

- FARLR_debias: Factor-augmented regularized latent regression with post
  debiasing.
